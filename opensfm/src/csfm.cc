...
BOOST_PYTHON_MODULE(csfm) {
  ...
  class_<BundleAdjuster, boost::noncopyable>("BundleAdjuster")
    ...
    .def("get_noncentral_subcamera", &BundleAdjuster::GetNoncentralSubcamera)
    .def("get_noncentral_subcamera_position", &BundleAdjuster::GetNoncentralSubcameraPosition)
    ...
    .def("add_noncentral_camera", &BundleAdjuster::AddNoncentralCamera)
    .def("make_noncentral_subcamera", &BundleAdjuster::MakeNoncentralSubcamera)
    ...
    .def("add_noncentral_observation", &BundleAdjuster::AddNoncentralObservation)
  ...
  class_<BANoncentralCameraPosition::S>("BANoncentralCameraPosition")
    .add_property("rx", &BANoncentralCameraPosition::S::rx)
    .add_property("ry", &BANoncentralCameraPosition::S::ry)
    .add_property("rz", &BANoncentralCameraPosition::S::rz)
    .add_property("tx", &BANoncentralCameraPosition::S::tx)
    .add_property("ty", &BANoncentralCameraPosition::S::ty)
    .add_property("tz", &BANoncentralCameraPosition::S::tz)
  ;
